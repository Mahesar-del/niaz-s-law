...
<html lang="en"><head>
    ...
    <meta name="robots" content="{{ $page->robots ?: 'index, follow' }}">content), 160) }}"><meta name="keywords" content="{{ $page->title }}, Niaz Law P.C., Illinois law firm, legal information"><link rel="stylesheet" href="{{ asset('css/app.css') }}"><style>
